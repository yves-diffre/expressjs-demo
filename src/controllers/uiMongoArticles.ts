...
async function displayArticles(request: Request, response: Response, next: NextFunction) {
  response.locals.page.current.mongoArticles = true;
...
async function editArticle(
  ...
  try {
    const result = await services.mongoArticles.editArticle(request.params._id, dto);
    response.flash({
...
async function removeArticle(
  ...
  try {
    const result = await services.mongoArticles.removeArticle(request.params._id);
    response.flash({
...
export const uiMongoArticlesControllers = {
  displayArticles,
  displayAddArticle,
  addArticle,
  displayArticle,
